...
using Project.Editor.EnterPlayMode.AsyncTools;
using Project.Editor.EnterPlayMode.BeforePlayMode;
using Project.Editor.EnterPlayMode.DoTweenTools;
using UnityEditor;

namespace Project.Editor.EnterPlayMode {
    [InitializeOnLoad]
