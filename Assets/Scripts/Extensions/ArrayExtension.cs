...
namespace Extensions {
    public static class ArrayExtension {
        public static void Swap<T>(this T[,,] array, int x1, int y1, int z1, int x2, int y2, int z2) {
            (array[x1, y1, z1], array[x2, y2, z2]) = (array[x2, y2, z2], array[x1, y1, z1]);
        }
        
        public static bool Remove<T>(this T[,,] array, T value) {
